...
if (localStorage.getItem("appData") != null) {
  ...
  axios.get("https://notebook.app.orght.cn/template/app-data-template.json").then((responce) => {
...
function addNote() {
  axios.get("https://notebook.app.orght.cn/template/new-note-template.json").then((responce) => {
